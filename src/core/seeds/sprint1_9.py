...
class SeedListaDeEspera ():
    ...
    def run(self):
        ...
        try:
            ...
            if self.db.session.query(Profesor).filter_by(email="profesorespera@gmail.com").first():
                print("💡 Datos de Lista de Espera (Sprint 1.9) ya existentes, no se realizaron cambios.")
                return
            ...
            print("✅ Datos de Lista de Espera (Sprint 1.9) poblados con éxito.")
        except Exception as e:
            self.db.session.rollback()
            print(f"❌ Error al poblar datos de Lista de Espera (Sprint 1.9): {e}")
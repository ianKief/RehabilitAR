...
class TipoNotificacion (enum.Enum):
    ...
    NUEVA_APELACION_A_CLASE = "nueva_apelacion_a_clase"
...
class Notificacion(Base):
    ...
    titulo: Mapped[String] = mapped_column(String(100), nullable=False)
    contenido: Mapped[String] = mapped_column(String(300), default="", nullable=False)
